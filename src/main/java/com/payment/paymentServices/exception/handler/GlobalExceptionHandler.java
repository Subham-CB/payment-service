...
public class GlobalExceptionHandler {
   ...
   @ExceptionHandler(MethodArgumentNotValidException.class)
    ...
    public ResponseEntity<ErrorResponseDto> invalidPaymentMethod(
    ...
    public ResponseEntity<ErrorResponseDto> statusNotFound(
       ...
       return build(HttpStatus.INTERNAL_SERVER_ERROR,"An internal server configuration occurred ",request);
    }
